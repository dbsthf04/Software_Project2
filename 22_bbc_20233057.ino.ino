...
#define _DUTY_MAX 2349 // 2000
#define _DUTY_NEU 1500 // 1500
#define _DUTY_MIN 521 // 1000

#define _SERVO_ANGLE_DIFF  192  // Replace with |D - E| degree
...
float volt_to_distance(int a_value)
{
  ...
  return 1052-6.01*a_value +0.0122*pow(a_value,2) -8.45*pow(10,-6)*pow(a_value,3);
}
